...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    if (indexPath.section == 0) {
        QLsendmecell* cell = [QLsendmecell cellwithTableview:tableView];
...
-(void)complain_action:(UIButton*)complainbtn {
    ...
    if (ip) {
        ...
        [QLglobalvar shareglobalvar].sendmevc = self;
        QLcomplaintvc* cvc = [[UIStoryboard storyboardWithName:@"complaint" bundle:nil]instantiateViewControllerWithIdentifier:@"complaint"];
        [cvc complaint_who:audioinfo.clientid nickname:audioinfo.nickname audioid:audioinfo.audioid onvcindex:5];
        [[QLglobalvar shareglobalvar].tabbarcontroller changevc_oversendme:cvc title:@"寡人怒了"];
    }
}
...
- (void)reset_lastaudioimage {
    ...
    if (selindexpath) {
        QLsendmecell* cell = (QLsendmecell*)[self.sendmetv cellForRowAtIndexPath:selindexpath];
