...
@interface QLzhiyiaboutvc ()

@end

@implementation QLzhiyiaboutvc
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    if (indexPath.section == 0) {
        if (indexPath.row == 0) {
            //TODO: 修改id
            [[UIApplication sharedApplication]openURL:[NSURL URLWithString:@"itms-apps://itunes.apple.com/app/id1444003492"]];
            NSLog(@"to appstore");
        }
        else if (indexPath.row == 1) {
            NSLog(@"to myweb");
