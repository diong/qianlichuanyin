...
@interface QLAudioRecorderMgr()<AVAudioRecorderDelegate>
{
...
@implementation QLAudioRecorderMgr

#define RECORD_FILE_DIR @"record_temp"

+ (QLAudioRecorderMgr *)shareAudioRecorderMgr
{
    static QLAudioRecorderMgr *shareAudioRecorderManager = nil;
