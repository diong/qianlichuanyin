...
@implementation QLcomplaintvc

-(void)resetvc {
    if (_vcindex == 0) {
        // tianya
        [[QLglobalvar shareglobalvar].tabbarcontroller resettianya];
    }
    else if (_vcindex == 3) {
        // ranklist
        [[QLglobalvar shareglobalvar].tabbarcontroller resetrank];
    }
    else if (_vcindex == 5) {
        // sendme
        [[QLglobalvar shareglobalvar].tabbarcontroller resetsendme];
    }
    else {
        [[QLglobalvar shareglobalvar].tabbarcontroller resettianya];
    }
...
- (void)viewDidLoad {
    ...
    [str addAttribute:NSForegroundColorAttributeName value:MAIN_BLUE_COLOR range:NSMakeRange(7,nicklen)];
