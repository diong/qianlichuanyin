...
- (void)refresh_support {
    if (_supportdirty) {
        ...
        [QLglobalvar shareglobalvar].tianya_support_dirty = _supportdirty;
        _supportdirty = NO;
    }
}
...
- (void)settableview {
    ...
    [header setTitle:@"天涯语音正在路上..." forState:MJRefreshStateRefreshing];
    ...
    [footer setTitle:@"天涯语音正在路上..." forState:MJRefreshStateRefreshing];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    if (indexPath.section == 0) {
        QLTianyaCell* cell = [QLTianyaCell cellwithTableview:tableView];
...
-(void)complain_action:(UIButton*)complainbtn {
    ...
    if (ip) {
        ...
        [cvc complaint_who:audioinfo.clientid nickname:audioinfo.nickname audioid:audioinfo.audioid onvcindex:0];
        [[QLglobalvar shareglobalvar].tabbarcontroller changevc_overtianya:cvc title:@"寡人怒了"];
    }
}
...
- (void)reset_lastaudioimage {
    ...
    if (selindexpath) {
        QLTianyaCell* cell = (QLTianyaCell*)[self.tianyatv cellForRowAtIndexPath:selindexpath];
...
-(void)viewDidAppear:(BOOL)animated {
    if ([QLglobalvar shareglobalvar].ranklist_support_dirty) {
        NSArray* ranklist_audiolist = [(QLRanklistvc*)[QLglobalvar shareglobalvar].ranklistvc ranklist_audiolist];
        BOOL needfresh = NO;
        ...
        [QLglobalvar shareglobalvar].ranklist_support_dirty = NO;
    }
